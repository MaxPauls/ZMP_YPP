...
public section.
  ...
  constants AREA_NAME type SHM_AREA_NAME value 'ZMP_AREA'. "#EC NOTEXT
  data ROOT type ref to ZMP_ROOT read-only .
  ...
  class-methods ATTACH_FOR_READ
    ...
    returning
      value(HANDLE) type ref to ZMP_AREA
    raising
      CX_SHM_INCONSISTENT
