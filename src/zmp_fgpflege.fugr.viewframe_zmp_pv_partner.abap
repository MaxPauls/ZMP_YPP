*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZMP_PV_PARTNER
*   generation date: 10.01.2019 at 08:02:00 by user PAULS
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZMP_PV_PARTNER      .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZMP_PV_PARTNER'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZMP_PV_PARTNER_EXTRACT
TOTAL = ZMP_PV_PARTNER_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZMP_PV_PARTNER'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZMP_PV_PARTNER-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZMP_PV_PARTNER_EXTRACT
TOTAL = ZMP_PV_PARTNER_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZMP_PV_PARTNER-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZMP_PV_PARTNER'
...
TOTAL = ZMP_PV_PARTNER_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZMP_PV_PARTNER-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZMP_PV_PARTNER-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZMP_PV_PARTNER'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZMP_PV_PARTNER-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZMP_PV_PARTNER_EXTRACT
TOTAL = ZMP_PV_PARTNER_TOTAL
